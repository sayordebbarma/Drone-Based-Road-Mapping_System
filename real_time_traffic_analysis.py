...
tuned_model = YOLO('models/best.pt')
...
# Open the video
cap = cv2.VideoCapture('Vehicle_Detection_Image_Dataset/sample_video2.mp4')
...
while cap.isOpened():
    ...
    if ret:
        ...
        results = tuned_model.predict(detection_frame, imgsz=640, conf=0.4)
